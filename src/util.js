...
// services/symbolIndex.js. Keeping the template + keywords here (rather than in
// ai_definition.js) lets symbolIndex reuse them without an import cycle
 ...
 */
const buildVariableRegex = variableName => {
 ...
 * @returns {boolean}
 */
const isVariableDeclarationLine = (lineText, variableName) => {
...
// Markdown formatting + completion/signature transforms are re-exported from
// completionTransforms.js for backward compatibility with the ~10 feature
// modules that still import them via util. Data files import them directly.
export {
  descriptionHeader,
  valueFirstHeader,
  trueFalseHeader,
...
export { VARIABLE_KEYWORDS };
export { VARIABLE_PATTERN_TEMPLATE };
export { VARIABLE_REGEX_FLAGS };
export { buildVariableRegex };
export { isVariableDeclarationLine };
